...
/**
 * PartTypeSkeletonView
 * Dedicated, pixel-matched, monochromatic skeleton for the Part Types view (Entrepôt).
 * Matches header banner, search bar with count badge, 6-column table, and pagination.
 */
function PartTypeSkeletonViewComponent() {
  return (
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs border-collapse min-w-[780px]">
            ...
            <tbody className="divide-y divide-slate-100">
              {[
                { idW: 'w-20', titleW: 'w-52', desigW: 'w-28', whW: 'w-24' },
                { idW: 'w-24', titleW: 'w-44', desigW: 'w-24', whW: 'w-28' },
                { idW: 'w-18', titleW: 'w-60', desigW: 'w-32', whW: 'w-20' },
                { idW: 'w-22', titleW: 'w-48', desigW: 'w-24', whW: 'w-24' },
                { idW: 'w-20', titleW: 'w-56', desigW: 'w-28', whW: 'w-26' },
                { idW: 'w-24', titleW: 'w-40', desigW: 'w-24', whW: 'w-22' },
              ].map((row, idx) => (
                <tr key={`part-type-skel-${idx}`} className="even:bg-slate-50/60 odd:bg-white">
                  ...
                  <td className="py-3 px-4">
                    <div className={`h-6 ${row.desigW} rounded-lg shimmer-wave`} />
                  </td>
                  <td className="py-3 px-4">
...
export const PartTypeSkeletonView = memo(PartTypeSkeletonViewComponent);
export default PartTypeSkeletonView;
