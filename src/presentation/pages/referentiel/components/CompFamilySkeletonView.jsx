...
/**
 * CompFamilySkeletonView
 * Dedicated, pixel-matched, monochromatic skeleton for the Component Families view (Entrepôt).
 * Matches header banner, search bar with count badge, 7-column table structure, and pagination.
 */
function CompFamilySkeletonViewComponent() {
  return (
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs border-collapse min-w-[850px]">
            ...
            <tbody className="divide-y divide-slate-100">
              {[
                { idW: 'w-20', titleW: 'w-52', codeW: 'w-16', tmplW: 'w-28', whW: 'w-24' },
                { idW: 'w-24', titleW: 'w-44', codeW: 'w-20', tmplW: 'w-24', whW: 'w-28' },
                { idW: 'w-18', titleW: 'w-60', codeW: 'w-18', tmplW: 'w-32', whW: 'w-20' },
                { idW: 'w-22', titleW: 'w-48', codeW: 'w-16', tmplW: 'w-24', whW: 'w-24' },
                { idW: 'w-20', titleW: 'w-56', codeW: 'w-22', tmplW: 'w-28', whW: 'w-26' },
                { idW: 'w-24', titleW: 'w-40', codeW: 'w-18', tmplW: 'w-24', whW: 'w-22' },
              ].map((row, idx) => (
                <tr key={`comp-fam-skel-${idx}`} className="even:bg-slate-50/60 odd:bg-white">
                  ...
                  <td className="py-3 px-4">
                    <div className={`h-5 ${row.codeW} rounded-md shimmer-wave`} />
                  </td>
                  <td className="py-3 px-4">
                    <div className={`h-6 ${row.tmplW} rounded-lg shimmer-wave`} />
                  </td>
                  <td className="py-3 px-4">
...
export const CompFamilySkeletonView = memo(CompFamilySkeletonViewComponent);
export default CompFamilySkeletonView;
