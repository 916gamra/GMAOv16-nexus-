...
/**
 * CompTemplateSkeletonView
 * Dedicated, pixel-matched, monochromatic skeleton for the Component Templates view (Entrepôt).
 * Matches header banner, 2-column filter bar, 6-column table, and pagination.
 */
function CompTemplateSkeletonViewComponent() {
  return (
    <div className="space-y-5 w-full min-w-0" aria-hidden="true">
      ...
      {/* 2. Filter Bar (Search + Component Family Select) */}
          ...
          <table className="w-full text-left text-xs border-collapse min-w-[800px]">
            <thead className="bg-slate-100 text-[10.5px] font-bold text-slate-700 uppercase tracking-wider border-b border-slate-200">
              <tr>
                ...
                <th className="py-2.5 px-4"><div className="h-3 w-48 rounded shimmer-wave" /></th>
                <th className="py-2.5 px-4"><div className="h-3 w-40 rounded shimmer-wave" /></th>
            ...
            <tbody className="divide-y divide-slate-100">
              {[
                { idW: 'w-24', titleW: 'w-48', famW: 'w-36', whW: 'w-24' },
                { idW: 'w-20', titleW: 'w-56', famW: 'w-30', whW: 'w-28' },
                { idW: 'w-22', titleW: 'w-40', famW: 'w-40', whW: 'w-20' },
                { idW: 'w-26', titleW: 'w-52', famW: 'w-28', whW: 'w-26' },
                { idW: 'w-20', titleW: 'w-44', famW: 'w-32', whW: 'w-22' },
                { idW: 'w-24', titleW: 'w-60', famW: 'w-38', whW: 'w-24' },
              ].map((row, idx) => (
                <tr key={`comp-tmpl-skel-${idx}`} className="even:bg-slate-50/60 odd:bg-white">
...
export const CompTemplateSkeletonView = memo(CompTemplateSkeletonViewComponent);
export default CompTemplateSkeletonView;
