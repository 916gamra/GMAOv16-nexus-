...
/**
 * FamilySkeletonView
 * Dedicated, pixel-matched, monochromatic skeleton for the Machine Families view.
 * Matches header banner, search bar with count badge, 6-column table structure, and pagination.
 */
function FamilySkeletonViewComponent() {
  return (
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs border-collapse min-w-[780px]">
            ...
            <tbody className="divide-y divide-slate-100">
              {[
                { idW: 'w-20', titleW: 'w-52', tmplW: 'w-28', mchW: 'w-24' },
                { idW: 'w-24', titleW: 'w-44', tmplW: 'w-24', mchW: 'w-28' },
                { idW: 'w-18', titleW: 'w-60', tmplW: 'w-32', mchW: 'w-20' },
                { idW: 'w-22', titleW: 'w-48', tmplW: 'w-24', mchW: 'w-24' },
                { idW: 'w-20', titleW: 'w-56', tmplW: 'w-28', mchW: 'w-26' },
                { idW: 'w-24', titleW: 'w-40', tmplW: 'w-24', mchW: 'w-22' },
              ].map((row, idx) => (
                <tr key={`fam-skel-row-${idx}`} className="even:bg-slate-50/60 odd:bg-white">
...
export const FamilySkeletonView = memo(FamilySkeletonViewComponent);
