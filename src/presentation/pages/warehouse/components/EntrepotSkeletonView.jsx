...
/**
 * EntrepotSkeletonView
 * Dedicated, pixel-matched, monochromatic skeleton for the Entrepôt & Warehouse view.
 * Features 4 KPI Cards, multi-field cascading filter bar, 10-column table structure, and pagination.
 */
function EntrepotSkeletonViewComponent() {
  return (
    <div className="space-y-5 w-full min-w-0" aria-hidden="true">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5">
        {[
          { labelW: 'w-28', valW: 'w-12' },
          { labelW: 'w-24', valW: 'w-10' },
          { labelW: 'w-32', valW: 'w-8' },
          { labelW: 'w-26', valW: 'w-14' },
        ].map((card, idx) => (
          <div
            key={`wh-kpi-skel-${idx}`}
          ...
          >
            <div className="space-y-1.5">
              <div className={`h-2.5 ${card.labelW} rounded shimmer-wave`} />
              <div className={`h-6.5 ${card.valW} rounded-md font-mono shimmer-wave`} />
            </div>
          ...
          <table className="w-full text-left text-xs border-collapse min-w-[1020px]">
            <thead className="bg-slate-100 text-[10.5px] font-bold text-slate-700 uppercase tracking-wider border-b border-slate-200">
              <tr>
                ...
                <th className="py-3 px-3.5 min-w-[200px]"><div className="h-3 w-36 rounded shimmer-wave" /></th>
                <th className="py-3 px-3.5 min-w-[180px]"><div className="h-3 w-32 rounded shimmer-wave" /></th>
                <th className="py-3 px-3.5 min-w-[150px]"><div className="h-3 w-28 rounded shimmer-wave" /></th>
                <th className="py-3 px-3.5 min-w-[140px]"><div className="h-3 w-24 rounded shimmer-wave" /></th>
                <th className="py-3 px-3 text-right min-w-[100px]"><div className="h-3 w-20 ml-auto rounded shimmer-wave" /></th>
                <th className="py-3 px-3 text-right min-w-[80px]"><div className="h-3 w-16 ml-auto rounded shimmer-wave" /></th>
                <th className="py-3 px-3 text-center min-w-[100px]"><div className="h-3 w-18 mx-auto rounded shimmer-wave" /></th>
                <th className="py-3 px-3.5 text-center min-w-[100px]"><div className="h-3 w-16 mx-auto rounded shimmer-wave" /></th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
              {[
                { codeW: 'w-24', titleW: 'w-52', subW: 'w-32', famW: 'w-20', tmplW: 'w-22', typeW: 'w-24', empW: 'w-20', stockW: 'w-12', seuilW: 'w-8', statW: 'w-18' },
                { codeW: 'w-20', titleW: 'w-44', subW: 'w-36', famW: 'w-24', tmplW: 'w-18', typeW: 'w-28', empW: 'w-24', stockW: 'w-10', seuilW: 'w-6', statW: 'w-20' },
                { codeW: 'w-26', titleW: 'w-60', subW: 'w-28', famW: 'w-18', tmplW: 'w-24', typeW: 'w-20', empW: 'w-18', stockW: 'w-14', seuilW: 'w-10', statW: 'w-16' },
                { codeW: 'w-22', titleW: 'w-48', subW: 'w-34', famW: 'w-22', tmplW: 'w-20', typeW: 'w-24', empW: 'w-22', stockW: 'w-10', seuilW: 'w-8', statW: 'w-18' },
                { codeW: 'w-28', titleW: 'w-56', subW: 'w-40', famW: 'w-20', tmplW: 'w-26', typeW: 'w-22', empW: 'w-26', stockW: 'w-12', seuilW: 'w-8', statW: 'w-22' },
                { codeW: 'w-20', titleW: 'w-40', subW: 'w-30', famW: 'w-24', tmplW: 'w-22', typeW: 'w-26', empW: 'w-20', stockW: 'w-8', seuilW: 'w-6', statW: 'w-18' },
              ].map((row, idx) => (
                <tr key={`wh-skel-row-${idx}`} className="even:bg-slate-50/60 odd:bg-white">
                  ...
                  <td className="py-3 px-3.5">
                    <div className={`h-5 ${row.typeW} rounded-md shimmer-wave`} />
                  </td>
                  <td className="py-3 px-3.5">
                    <div className={`h-5 ${row.empW} rounded-md shimmer-wave`} />
                  </td>
                  <td className="py-3 px-3 text-right">
                    <div className={`h-5 ${row.stockW} rounded-md ml-auto font-mono shimmer-wave`} />
                  </td>
                  <td className="py-3 px-3 text-right">
                    <div className={`h-5 ${row.seuilW} rounded-md ml-auto font-mono shimmer-wave`} />
                  </td>
...
export const EntrepotSkeletonView = memo(EntrepotSkeletonViewComponent);
export default EntrepotSkeletonView;
